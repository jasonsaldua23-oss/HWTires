...
<main class="forecasting-page">
    ...
    <section class="forecast-secondary-filter-card" aria-label="Forecast filters">
        <form method="get" action="./#forecast-analysis" class="forecast-compact-filters">
            ...
            <?php if ($category_filter !== 'all' || $status_filter !== 'all' || $view_filter !== 'weekly'): ?>
                <a class="forecast-compact-reset"
                   href="<?php echo esc_attr(forecast_filter_url('all', $branch_filter, 'all', $search_filter, $per_page, null, $year_filter, 'weekly')); ?>#forecast-analysis">
                    Reset filters
                </a>
            <?php endif; ?>
        </form>
