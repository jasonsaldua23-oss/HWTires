                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control vehicle-make-custom mt-2" name="make_custom" id="profile_add_veh_make_custom" placeholder="Type custom car brand..." style="display: none;">
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control vehicle-model-custom mt-2" name="model_custom" id="profile_add_veh_model_custom" placeholder="Type custom model..." style="display: none;">
                        </div>
                    </div>
