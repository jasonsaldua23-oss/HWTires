...
if (!function_exists('front_inventory_filter_url')) {
    function front_inventory_filter_url($category, $search = '', $per_page = null, $page = null, $view = 'all') {
        $query = [];
...
$active_filter_url = front_inventory_filter_url($category_filter, $search_filter, $per_page, $page, $view_filter);
    ...
    <section class="inventory-summary-grid" aria-label="Inventory summary">
        ...
        <article class="inventory-summary-card">
            <div>
                ...
                <strong><?php echo front_inventory_money($stats['total_stock_value'] ?? 0); ?></strong>
            </div>
        ...
        <?php if ($total_pages > 1): ?>
            <nav class="records-pagination inventory-records-pagination" aria-label="Inventory records pages">
                <ul class="pagination justify-content-center">
                    <?php if ($page > 1): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo esc_attr(front_inventory_filter_url($category_filter, $search_filter, $per_page, 1, $view_filter)); ?>#inventory-records">First</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo esc_attr(front_inventory_filter_url($category_filter, $search_filter, $per_page, $page - 1, $view_filter)); ?>#inventory-records">Previous</a>
                        </li>
                    <?php endif; ?>
                    <?php for ($i = max(1, $page - 2); $i <= min($total_pages, $page + 2); $i++): ?>
                        <li class="page-item <?php echo $i === $page ? 'active' : ''; ?>">
                            <a class="page-link" href="<?php echo esc_attr(front_inventory_filter_url($category_filter, $search_filter, $per_page, $i, $view_filter)); ?>#inventory-records"><?php echo (int) $i; ?></a>
                        </li>
                    <?php endfor; ?>
                    <?php if ($page < $total_pages): ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo esc_attr(front_inventory_filter_url($category_filter, $search_filter, $per_page, $page + 1, $view_filter)); ?>#inventory-records">Next</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link" href="<?php echo esc_attr(front_inventory_filter_url($category_filter, $search_filter, $per_page, $total_pages, $view_filter)); ?>#inventory-records">Last</a>
                        </li>
                    <?php endif; ?>
                </ul>
            </nav>
