    ...
    FROM (
        SELECT
            ...
            COALESCE((
                ...
                LIMIT 1
            ), branch_home.name) AS last_visited_branch,
...
<main class="reports-page frontdesk-reports-page">
    ...
    <section class="reports-filter-card hw-filter-card">
        ...
        <form method="GET" class="reports-filter-form front-reports-filter-form reports-detail-filter-form hw-filter-toolbar">
            <div class="hw-filter-cluster">
                ...
                <div class="hw-filter-group hw-group-md no-print">
                    <label for="frontReportsQuickRange" class="hw-filter-label">Quick Range</label>
                    <select id="frontReportsQuickRange" name="quick_range" class="hw-filter-select reports-quick-range-select" onchange="reportsSyncQuickRange(this)">
                ...
                <div class="hw-filter-group hw-group-date" data-range-custom <?php echo $quick_report_range_value !== 'custom' ? 'hidden' : ''; ?>>
                    <label for="frontReportsDateFrom" class="hw-filter-label">Date From</label>
                    <input id="frontReportsDateFrom" type="date" name="date_from" class="hw-filter-input" value="<?php echo esc_attr($date_from); ?>">
                </div>
                <div class="hw-filter-group hw-group-date" data-range-custom <?php echo $quick_report_range_value !== 'custom' ? 'hidden' : ''; ?>>
                    <label for="frontReportsDateTo" class="hw-filter-label">Date To</label>
                    <input id="frontReportsDateTo" type="date" name="date_to" class="hw-filter-input" value="<?php echo esc_attr($date_to); ?>">
                </div>
                <div class="hw-filter-actions">
                    ...
                    <a href="./" class="btn btn-outline-secondary hw-filter-icon-btn hw-btn-reset" title="Reset filters" aria-label="Reset filters">
            ...
            <div class="hw-search-cluster">
                <div class="hw-filter-group hw-group-search flex-grow-1">
                    <label for="frontReportsSearch" class="hw-filter-label">Search</label>
                    <div class="hw-search-wrapper">
                        <input id="frontReportsSearch"
                               type="search"
                               name="search"
                               maxlength="100"
