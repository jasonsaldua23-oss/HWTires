    ...
    <section class="customer-records-filter-card hw-filter-card">
        <form method="GET" action="./#customer-records" class="customer-records-filter hw-filter-toolbar" data-record-date-filter>
            <div class="hw-filter-group hw-group-branch">
                <label for="adminCustomerBranch" class="hw-filter-label">Branch</label>
                <select id="adminCustomerBranch" name="branch" class="hw-filter-select customer-branch-select">
            ...
            <div class="hw-filter-group hw-group-operation">
                <label for="adminCustomerOperation" class="hw-filter-label">Latest Operation</label>
                <select id="adminCustomerOperation" name="operation_status" class="hw-filter-select customer-operation-select">
            ...
            <div class="hw-filter-group hw-group-service-status">
                <label for="adminCustomerStatus" class="hw-filter-label">Latest Service Status</label>
                <select id="adminCustomerStatus" name="status" class="hw-filter-select customer-status-select">
            ...
            <div class="hw-filter-group hw-group-status">
                <label for="adminCustomerRecords" class="hw-filter-label">Status</label>
                <select id="adminCustomerRecords" name="records" class="hw-filter-select customer-record-select">
            ...
            <div class="hw-filter-group hw-group-date">
                <label for="adminCustomerDateScope" class="hw-filter-label">Period</label>
                <select id="adminCustomerDateScope" name="date_scope" class="records-date-scope hw-filter-select customer-date-select" aria-label="Select record period">
            ...
            <div class="hw-filter-group" data-date-input="day">
                <label for="adminCustomerDateDay" class="hw-filter-label">Day</label>
                <input id="adminCustomerDateDay" type="date" name="date_day" class="hw-filter-input" value="<?php echo esc_attr($date_filter['day']); ?>">
            </div>
            <div class="hw-filter-group" data-date-input="week">
                <label for="adminCustomerDateWeek" class="hw-filter-label">Week</label>
                <input id="adminCustomerDateWeek" type="week" name="date_week" class="hw-filter-input" value="<?php echo esc_attr($date_filter['week']); ?>">
            </div>
            <div class="hw-filter-group" data-date-input="month">
                <label for="adminCustomerDateMonth" class="hw-filter-label">Month</label>
                <input id="adminCustomerDateMonth" type="month" name="date_month" class="hw-filter-input" value="<?php echo esc_attr($date_filter['month']); ?>">
            </div>
            <div class="hw-filter-group" data-date-input="year">
                <label for="adminCustomerDateYear" class="hw-filter-label">Year</label>
                <input id="adminCustomerDateYear" type="number" name="date_year" min="2020" max="2100" class="hw-filter-input" value="<?php echo (int) $date_filter['year']; ?>">
            </div>
            <div class="hw-filter-group" data-date-input="range">
                <label for="adminCustomerDateFrom" class="hw-filter-label">From</label>
                <input id="adminCustomerDateFrom" type="date" name="date_from" class="hw-filter-input" value="<?php echo esc_attr($date_filter['from']); ?>">
            </div>
            <div class="hw-filter-group" data-date-input="range">
                <label for="adminCustomerDateTo" class="hw-filter-label">To</label>
                <input id="adminCustomerDateTo" type="date" name="date_to" class="hw-filter-input" value="<?php echo esc_attr($date_filter['to']); ?>">
            </div>
            ...
            <div class="hw-search-cluster">
                <div class="hw-filter-group hw-group-search flex-grow-1">
                    <label for="adminCustomerSearch" class="hw-filter-label">Search</label>
                    <div class="hw-search-wrapper">
                        <input id="adminCustomerSearch" type="text" name="search" maxlength="100" data-text-format="first-letter" class="hw-search-input" placeholder="Search by vehicle, plate number, customer, or branch..." value="<?php echo esc_attr($search); ?>">
                    </div>
                </div>
                <div class="hw-filter-actions">
